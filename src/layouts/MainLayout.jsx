...
import { BookOpen, Mic, GraduationCap, Settings, Home, LogOut, User as UserIcon, ClipboardList, LayoutDashboard, Trophy } from 'lucide-react';
...
const MainLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/leaderboard', label: '排行榜', icon: Trophy, roles: ['STUDENT', 'TEACHER', 'VISITOR'] },
